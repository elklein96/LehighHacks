    ...
    $("input,textarea").jqBootstrapValidation({
        ...
        submitSuccess: function($form, event) {
            ...
            function loaded(evt) {  
                ...
                var data = {"firstName": $('#Field1').val(), "lastName": $('#Field2').val(), "email": $('#Field3').val(), "phone": $('#Field4').val().replace("-", ""), "suggestions": $('#Field5').val(), "resume": resumeData, "dietary": $('#Field8').val(), "first": firstHackathon};
                $.ajax({
